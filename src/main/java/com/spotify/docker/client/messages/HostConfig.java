...
public class HostConfig {
   ...
   */
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("binds", binds).add("blkioWeight", blkioWeight).add("blkioWeightDevice", blkioWeightDevice).add("blkioDeviceReadBps", blkioDeviceReadBps).add("blkioDeviceWriteBps", blkioDeviceWriteBps).add("blkioDeviceReadIOps", blkioDeviceReadIOps).add("blkioDeviceWriteIOps", blkioDeviceWriteIOps).add("containerIdFile", containerIdFile).add("lxcConf", lxcConf).add("privileged", privileged).add("portBindings", portBindings).add("links", links).add("publishAllPorts", publishAllPorts).add("dns", dns).add("dnsOptions", dnsOptions).add("dnsSearch", dnsSearch).add("extraHosts", extraHosts).add("volumesFrom", volumesFrom).add("capAdd", capAdd).add("capDrop", capDrop).add("networkMode", networkMode).add("securityOpt", securityOpt).add("devices", devices).add("memory", memory).add("memorySwap", memorySwap).add("memorySwappiness", memorySwappiness).add("memoryReservation", memoryReservation).add("cpuPeriod", cpuPeriod).add("cpuShares", cpuShares).add("cpusetCpus", cpusetCpus).add("cpusetMems", cpusetMems).add("cpuQuota", cpuQuota).add("cgroupParent", cgroupParent).add("restartPolicy", restartPolicy).add("logConfig", logConfig).add("ipcMode", ipcMode).add("ulimits", ulimits).add("pidMode", pidMode).add("shmSize", shmSize).add("oomKillDisable", oomKillDisable).add("oomScoreAdj", oomScoreAdj).add("autoRemove", autoRemove).add("pidsLimit", pidsLimit).add("tmpfs", tmpfs).add("readonlyRootfs", readonlyRootfs).toString();
    }
    ...
    public static class BlkioWeightDevice {
        ...
        public boolean equals(Object obj) {
            ...
            return com.google.common.base.Objects.equal(path, that.path) && com.google.common.base.Objects.equal(weight, that.weight);
        }
        ...
        @Override
        public String toString() {
            return MoreObjects.toStringHelper(this).add("path", path).add("weight", weight).toString();
        }
    ...
    public static class BlkioDeviceRate {
        ...
        @JsonCreator
        static BlkioDeviceRate create(@JsonProperty("Path") final String path, @JsonProperty("Rate") final Integer rate) {
        ...
        public boolean equals(Object obj) {
            ...
            return com.google.common.base.Objects.equal(path, that.path) && com.google.common.base.Objects.equal(rate, that.rate);
        }
        ...
        @Override
        public String toString() {
            return MoreObjects.toStringHelper(this).add("path", path).add("rate", rate).toString();
        }
